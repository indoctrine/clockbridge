...
class TestVerifyWebhookSignature:
    ...
    def test_no_signature(self):
        ...
        headers = {}
        assert self.bridge.verify_webhook_signature(headers, self.config.webhook_secrets) is False
    ...
    def test_signature_is_correct(self):
        ...
        assert self.bridge.verify_webhook_signature(headers, self.config.webhook_secrets) is True
